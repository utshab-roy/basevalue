    ...
    function get_settings_fields() {
        $settings_fields = array(
	        ...
	        'my_settings'  => array(
		        array(
			        'name'    => 'radio',
			        'label'   => __( 'JS Option', 'wedevs' ),
			        'desc'    => __( 'To turn on / off the JS', 'wedevs' ),
			        'type'    => 'radio',
			        'options' => array(
				        'yes' => 'Yes',
				        'no'  => 'No'
		        ...
		        array(
		        	'name' => 'namefield',
			        'label' => __('Name Field', 'pubg'),
			        'desc' => __('This is the name field', 'pubg'),
			        'placeholder'       => __( 'Text Input placeholder', 'pubg' ),
			        'type' => 'text',
		        )
	        ),
        );
